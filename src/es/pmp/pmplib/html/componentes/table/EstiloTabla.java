...
public class EstiloTabla {
    ...
    public static final String COLOR_NARANJA        = "#FFA350";
    ...
    public void setEstilo(EstiloTabla estilo) {
        ...
        this.clase_td_separacion_vertical           = estilo.clase_td_separacion_vertical;
    }
    ...
    public static EstiloTabla getEstiloTablaAzul() {
        ...
        estilo_azul.clase_td_separacion_vertical    = "azul_td_separacion_vertical";
